    ...
    <Layout user={props.user}>
      ...
      <div className="about-us-profiles">
        ...
        <div className="about-us-profile-info">
          <h2>Amy Kumar</h2>
          <p>Thomas Sten is a software engineer with over 15 years of military experience. His passion for learning combined with his optimistic demeanor has resulted in a richly rewarding experience as a software engineer.</p>
        ...
        <div className="about-us-profile-info">
          ...
          <div class="about-us-contact">
            ...
            <a href="https://www.linkedin.com/in/thomas-sten/">
              <img class="social" src="https://res.cloudinary.com/briandanger/image/upload/v1568954107/linkedin_vnvo6s.png"/>
              </a>
              </div>
          </div>
        </div>
      ...
      <div className="about-us-profiles">
        ...
        <div className="about-us-profile-info">
          ...
          <p>Gylych is an efficient junior web developer with a Master's degree in Web and App Development. He has a complete understanding of the entire software development lifecycle. He is looking for an entry-level opportunity in a dynamic organization where his skills will be fully utilized. </p>
          <div class="about-us-contact">
            <p>Github: </p>
